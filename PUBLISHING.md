...
*(Example output: `bin\Release\Arpan.AIBridge.1.0.1.nupkg`)*
...
6. Under "Glob Pattern", enter `Arpan.AIBridge`.
...
```bash
dotnet nuget push .\bin\Release\Arpan.AIBridge.1.0.1.nupkg --api-key YOUR_API_KEY --source https://api.nuget.org/v3/index.json
```
