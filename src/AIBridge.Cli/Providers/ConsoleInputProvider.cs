...
namespace AIBridge.Cli.Providers;
...
public class ConsoleInputProvider : IInputProvider
{
    ...
    public Task<string?> GetPrimaryInputAsync()
    {
    ...
    public Task<string?> GetFallbackInputAsync(string prompt)
    {
        Console.WriteLine();
    ...
    public Task SetOutputContextAsync(string text)
    {
        var (fileName, clipArgs) = CurrentPlatform switch
        {
