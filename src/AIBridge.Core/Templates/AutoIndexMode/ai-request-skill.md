...
When you are working from the index XML file map, you do not have the full source code for the files. To perform complex coding tasks, you must ask the system to provide the full contents of the specific files you need.
...
1. **Exact Paths:** The `path` attribute must exactly match the `path` attribute found in the index XML file.
...
*(User has only provided the index XML file)*
